...
<div class="top-bar">
    ...
    <li class="link-item"><a href="user_login.php" class="link">Hello, sign in</a></li>
...
<nav class="navbar">
        <div class="nav">
                ...
                <a href="C:\wamp64\www\innova-computer accessories\users_area\profile.php"><img src="../images\New folder\avatar.png" alt="user"></a>
